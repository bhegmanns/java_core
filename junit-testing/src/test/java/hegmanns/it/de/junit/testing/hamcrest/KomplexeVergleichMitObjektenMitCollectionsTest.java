...
/**
 * Diese Klasse demonstriert die Verwendung der Hamcrest-Matcher
 * mit Collections und deren Elementen.
 * 
 * @author B. Hegmanns
 */
public class KomplexeVergleichMitObjektenMitCollectionsTest {
	...
	/**
	 * Beispiel fuer eine Ueberpruefung an allen Elementen einer Collection.
	 * Die angegebenen Bedingungen muessen auf ALLE Elemente zutreffen.
	 * 
	 * <p>
	 * 	Es werden an jedem Element gleich mehrere Pruefungen durchgefuehrt:<br>
	 *  Die Kontonummer soll bei allen Elementen mit "1111" starten.
	 *  Das Saldo jedes Kontos soll mindestens 0 betragen, also positiv sein.
	 * </p>
	 */
	@Test
	...
	/**
	 * Beispiel fuer die Ueberpruefung an allen Elementen einer Collection.
	 * Die angegebene Bedingung muss auf MINDESTENS EIN Element zutreffen.
	 * 
	 * <p>
	...
	MatcherFactory.oder(MatcherFactory.und(Matchers.hasProperty("kontoart", Matchers.not(Kontoart.GIROKONTO)), 
			Matchers.hasProperty("kreditlinie", Matchers.nullValue())), MatcherFactory.und(Matchers.hasProperty("kontoart", Matchers.is(Kontoart.GIROKONTO)),
