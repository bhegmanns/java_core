...
public class KomplexeVergleicheAmObjekt {
	...
	public void nurSparkontoHatKreditlinie(){
		...
		// umfangreicher Test
		MatcherAssert.assertThat("", sparkonto, 
				Matchers.anyOf(
						Matchers.allOf(
								Matchers.hasProperty("kontoart", Matchers.not(Kontoart.GIROKONTO)), 
								Matchers.hasProperty("kreditlinie", Matchers.nullValue())),
						Matchers.allOf(
								Matchers.hasProperty("kontoart", Matchers.is(Kontoart.GIROKONTO)),
								Matchers.hasProperty("kreditlinie", Matchers.notNullValue()))
								));
		
		MatcherAssert.assertThat("", girokonto, 
				Matchers.anyOf(
						Matchers.allOf(
								Matchers.hasProperty("kontoart", Matchers.not(Kontoart.GIROKONTO)), 
								Matchers.hasProperty("kreditlinie", Matchers.nullValue())),
	...
	public void nurSparkontoHatKreditlinieMitFactory(){
		MatcherAssert.assertThat("", girokonto, oder(und(Matchers.hasProperty("kontoart", Matchers.not(Kontoart.GIROKONTO)), 
								Matchers.hasProperty("kreditlinie", Matchers.nullValue())), und(Matchers.hasProperty("kontoart", Matchers.is(Kontoart.GIROKONTO)),
								Matchers.hasProperty("kreditlinie", Matchers.notNullValue()))));
		
		MatcherAssert.assertThat("", sparkonto, oder(und(Matchers.hasProperty("kontoart", Matchers.not(Kontoart.GIROKONTO)), 
				Matchers.hasProperty("kreditlinie", Matchers.nullValue())), und(Matchers.hasProperty("kontoart", Matchers.is(Kontoart.GIROKONTO)),
				Matchers.hasProperty("kreditlinie", Matchers.notNullValue()))));
	}
