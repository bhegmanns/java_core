...
public class ZeichenkettenTest {
	...
	public void leerzeichenRechtsAuffuellenUeberlangerText(){
		...
		MatcherAssert.assertThat("Habe gleiche Laengen fuer neuerText und text erwartet (text-Laenge groesser als 5, daher wird nicht aufgefuellt).", neuerText.length(), Matchers.is(text.length()));
	}
