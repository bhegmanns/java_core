...
public class EinfacheVergleicheMitHamcrestTest {
	...
	public void behandlungMitNullCollection(){
		...
		Assert.fail("Habe AssertionError erwartet.");
			...
			MatcherAssert.assertThat("Message '" + e.getMessage() + "' matched nicht auf regulaeren Ausdruck.", e.getMessage(), RegexMatcher.findWithRegex("Expected: iterable containing.*a.*b.*c.*\n.*but: was null")); // iterable containing.*a.*b.*c.*was null
		}
